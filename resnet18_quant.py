...
parser.add_argument(
    "--data_dir",
    default="/workspace/yolov7/MTV2/",
    help="Data set directory, when quant_mode=calib, it is for calibration, while quant_mode=test it is for evaluation",
)
parser.add_argument(
    "--model_dir",
    default="/workspace/src/vai_quantizer/vai_q_pytorch/example/",
    # default="/home/ning/Vitis-AI/src/vai_quantizer/vai_q_pytorch/example/",
...
parser.add_argument(
    "--fast_finetune", dest="fast_finetune", action="store_true", help="fast finetune model before calibration"
)
...
parser.add_argument(
    "--target", dest="target", default="DPUCAHX8L_ISA0_SP", nargs="?", const="", help="specify target device"
)
